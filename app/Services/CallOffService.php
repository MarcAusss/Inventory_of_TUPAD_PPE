    ...
    public function assignAndApprove(
        ...
        return DB::transaction(function () use (
            ...
            $callOff = CallOff::query()->create([
                ...
                'assigned_at' => now(),
                'nefa_title' => $batch->call_off_letter_nefa_title,
                'print_total_amount' => $batch->call_off_letter_total_amount,
                'print_margin_top' => $batch->call_off_letter_margin_top,
                'print_margin_right' => $batch->call_off_letter_margin_right,
                'print_margin_bottom' => $batch->call_off_letter_margin_bottom,
                'print_margin_left' => $batch->call_off_letter_margin_left,
